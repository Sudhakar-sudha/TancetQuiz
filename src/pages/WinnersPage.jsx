...
//   { name: "BalaVignesh", score: 53, rank: 6 },
// ];
...
// const badgeColors = ["bg-yellow-500", "bg-gray-500", "bg-orange-500", "bg-blue-500", "bg-green-500" , "bg-blue-500"];
...
const badgeColors = ["bg-yellow-500", "bg-gray-500", "bg-orange-500", "bg-blue-500", "bg-green-500", "bg-purple-500"];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-800 to-purple-600 p-6 text-white flex flex-col items-center">
      <motion.h1
        ...
        transition={{ duration: 1.5 }}
      >
        🏆 TANCET Mock Test Top 6 Winners 🏆
      </motion.h1>
