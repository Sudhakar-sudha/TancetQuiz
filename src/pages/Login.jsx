    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-500 to-green-300 p-6">
      <div className="bg-white p-10 rounded-lg shadow-lg w-auto h-auto ">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full cursor-pointer bg-green-500 text-white py-2 rounded-lg font-semibold text-lg transition duration-300 hover:bg-blue-600 focus:ring-2 focus:ring-blue-300"
          >
            Login
          </button>
        </form>
